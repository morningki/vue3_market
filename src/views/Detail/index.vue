<script setup>
import { getDetail } from '@/apis/category';
    ...
    <div class="container">
      <div class="bread-container">
        <el-breadcrumb separator=">">
          ...
          <!-- detailList一开始是空的{}
           所以这边变成了 {}.categories 就等于是undefined了 取数组就变成了undefined[1]了
           解决方法：1.可选链？
                    2.使用v-if控制有数据时才渲染 v-if="detailList.categories" -->
          <el-breadcrumb-item :to="{ path: '`/category/detail/${detailList.categories?.[0].id}`' }">{{ detailList.categories?.[0].name }}
          </el-breadcrumb-item>
            ...
            <div class="goods-article">
              ...
              <div class="goods-tabs">
                ...
                <div class="goods-detail">
                  ...
                  <template v-if="detailList.details">
                   <img v-for="item in detailList.details.pictures"  :src="item" :key="item.id" >
                   </template>
                </div>
